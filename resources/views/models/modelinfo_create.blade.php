<x-app-layout>
    <div class="flex items-center justify-center mt-8 ">
        <div class="bg-white p-6 rounded-lg  w-full">
            <h1 class="text-2xl font-bold mb-14 text-center text-blue-600">Edit Module Information</h1>
            ...
            <form action="{{ route('model.store') }}" method="POST" class="flex flex-wrap">
                ...
                <div class="mb-4 px-2 w-1/2">
                    ...
                    <input type="text" name="module_title" id="module_title"
                        class="border border-blue-300 rounded-lg py-4 px-3 w-full focus:outline-none focus:border-blue-500"
                        required>
                    @error('module_title')
                ...
                <div class="mb-4 w-full px-2 flex justify-center mt-4">
                    <button type="submit"
                        class="bg-blue-500 hover:bg-blue-700 text-white font-medium py-4 px-4 rounded-lg focus:outline-none focus:shadow-outline">Create
