...
<x-app-layout>
                                            ...
                                            <tr>
                                                <th scope="col" class="p-4">
                                                    <div class="flex items-center">
                                                        <input id="checkbox-all" type="checkbox" class="w-4 h-4 bg-blue-200 text-blue-500 rounded-sm focus:text-blue-500 focus:border focus:bg-blue-500 focus:ring-2">
                                                ...
                                                <th scope="col" class="py-3 px-6 text-xs font-medium tracking-wider text-right text-white">
                                        ...
                                        <tbody class="bg-blue-600 divide-y">
                                            ...
                                            <tr class="bg-blue-300">
                                                ...
                                                <td class="py-4 px-6 text-sm font-medium text-right whitespace-nowrap">
                                                    <form action="{{ route('plandelivery.destroy', ['DeliveryPlan' => $content->id]) }}" method="POST">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="submit" class="text-red-600 dark:red-blue-500 font-bold hover:underline bg-transparent border-none cursor-pointer">Delete</button>
                                                    </form>
    ...
    <div class="text-center w-full md:w-2/4 min-h-52 mt-8 border test relative rounded-xl">
        <h5 class="mb-2 text-2xl font-bold tracking-tight text-white">Module Aims, Learning Outcomes and Indicative Contents</h5>
        ...
        <div class="absolute bottom-4 left-1/2 transform -translate-x-1/2">
            <a href="{{ route('model.aims', $model->id) }}" class="bg-white text-black font-bold py-2 px-12 rounded focus:outline-none focus:shadow-outline">Edit</a>
        </div>
    </div>

    <div class="text-center mt-8 w-full md:w-2/4 h-52 test2 relative rounded-xl">
        <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Relation With Other Modules</h5>
        ...
        <div class="absolute bottom-4 left-1/2 transform -translate-x-1/2">
            <a href="{{ route('model.related', $model->id) }}" class="bg-white text-black font-bold py-2 px-12 rounded focus:outline-none focus:shadow-outline">Edit</a>
        </div>
    </div>

    <div class="text-center mt-8 w-full md:w-2/4 h-52 test3 relative rounded-xl">
        <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Learning and Teaching Strategies</h5>
        ...
        <div class="absolute bottom-4 left-1/2 transform -translate-x-1/2">
            <a href="{{ route('model.strategie', $model->id) }}" class="bg-white text-black font-bold py-2 px-12 rounded focus:outline-none focus:shadow-outline">Edit</a>
        </div>
    </div>
    ...
    <div class="text-center mt-8 w-full md:w-2/4 h-52 test4 relative rounded-xl">
        ...
        <div class="absolute bottom-4 left-1/2 transform -translate-x-1/2">
            <a href="{{ route('model.resources', $model->id) }}" class="bg-white text-black font-bold py-2 px-12 rounded focus:outline-none focus:shadow-outline">Edit</a>
        </div>
    </div>
</div>
