        ...
        <div class="flex justify-between h-20 items-center">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6 bg-">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button
                            class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-bold rounded-md text-gray-600  hover:text-blue-600 focus:outline-none transition ease-in-out duration-150 user">
            ...
            <div class="-me-2 flex items-center sm:hidden">
                <button @click="open = ! open"
                    class="inline-flex items-center justify-center p-2 rounded-md text-blue-600 hover:text-grey-600 hover:bg-blue-200 focus:outline-none focus:bg-blue-200 focus:text-blue-600 transition duration-150 ease-in-out">
